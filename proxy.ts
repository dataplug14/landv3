...
const buildContentSecurityPolicy = (nonce: string) =>
  [
    "default-src 'self';",
    `script-src 'self' 'unsafe-inline' 'unsafe-eval' https://unpkg.com https://cdn.jsdelivr.net https://static.cloudflareinsights.com https://www.googletagmanager.com https://www.google-analytics.com https://salesiq.zohopublic.com;`,
